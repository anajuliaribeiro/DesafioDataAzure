...
cont_linha = 0 # contador de linhas 
tam_array_dados = len(array_dados) - 1 #tamanho do array, quantidades de linhas 

#leitura do array de resultados do banco
for transacao in array_dados:

    if cont_linha != tam_array_dados: #vê se a linha não é última
        ...
        if cliente_atual == prox_cliente :
            ...
            print("Novo cliente")
        cont_tran += 1
    cont_linha += 1 #incrementa a linha 
